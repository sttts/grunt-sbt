...
object GruntSbtPlugin extends Plugin {
  ...
  object GruntKeys {
    ...
    var gruntBaseDirectory = settingKey[String]("Directory path " +
      "containing the Gruntfile.js and package.json files. By default this is " +
  ...
  lazy val gruntTask: Def.Initialize[Task[Seq[File]]] = Def.task {
    ...
    val baseDir = if (gruntBaseDirectory.value.isEmpty) thisProject.value.base else file(gruntBaseDirectory.value)
  ...
  lazy val npmInstallTask: Def.Initialize[Task[Int]] = Def.task {
    ...
    val baseDir = if (gruntBaseDirectory.value.isEmpty) thisProject.value.base else file(gruntBaseDirectory.value)
    val pkgFileExists = (baseDir / "package.json").exists
